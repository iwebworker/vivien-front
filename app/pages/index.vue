      ...
      <div class="flex flex-wrap gap-3 items-center">
        ...
        <div class="relative flex-1 min-w-[100px]">
          <input
              ...
              class="w-full pl-10 pr-4 py-2.5 text-black dark:text-black bg-light-bg dark:bg-white border border-light-border dark:border-purple-400/50 rounded-xl focus:border-purple-400/50 focus:ring-2 focus:ring-purple-400/20"
          />
